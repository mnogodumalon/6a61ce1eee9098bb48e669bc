// Auto-generated. Per-entity form-enhancements config for "Restaurant & Speisekarte".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['name', 'kueche', 'telefon', 'bestelllink', 'speisekarte', 'hinweise'],
  defaults: {
    'kueche': { kind: 'lookup', key: 'italienisch', label: 'Italienisch' },
  },
  computed: {},
};
