// Auto-generated. Per-entity form-enhancements config for "Meine Bestellung".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['bestellrunde', { row: ['vorname', 'nachname'] }, 'gerichte', 'sonderwuensche', 'betrag', 'bezahlt'],
  defaults: {
