// Auto-generated. Per-entity form-enhancements config for "Bestellrunde".
...
export const formEnhancements: FormEnhancements = {
  fieldOrder: ['bezeichnung', 'bestelldatum', 'bestellschluss', 'restaurant', { row: ['koordinator_vorname', 'koordinator_nachname'] }, 'anmerkungen'],
  defaults: {
    'bestelldatum': { kind: 'today', withTime: true },
  },
  computed: {},
};
