 ...
 *   …
 *   // <custom:intents>
  { path: '/intents/bestellrunde-starten', label: 'Bestellrunde starten', icon: IconShoppingCartPlus, description: 'Restaurant wählen, Runde anlegen und Bestellungen erfassen' },
  // </custom:intents>
 */
